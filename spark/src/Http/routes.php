...
$router->group(['middleware' => 'web'], function ($router) {
    ...
    $router->get('/spark/base-plans', 'PlanController@basePlans');
    ...
    // Kiosk Merchants...
    $router->get('/spark/kiosk/merchants', 'Kiosk\MerchantController@get')->name('spark.kiosk.merchants.get');
    $router->put('/spark/kiosk/merchant/{id}', 'Kiosk\MerchantController@update')->name('spark.kiosk.merchants.update');

    // Kiosk Resources...
    $router->get('/spark/kiosk/resources', 'Kiosk\ResourceController@get')->name('spark.kiosk.resources.get');
    $router->post('/spark/kiosk/resources', 'Kiosk\ResourceController@store')->name('spark.kiosk.resources.store');
    $router->get('/spark/kiosk/resource/create', 'Kiosk\ResourceController@create')->name('spark.kiosk.resources.create');
    $router->get('/spark/kiosk/resource/{id}', 'Kiosk\ResourceController@edit')->name('spark.kiosk.resources.edit');
    $router->put('/spark/kiosk/resource/{id}', 'Kiosk\ResourceController@update')->name('spark.kiosk.resources.update');

    $router->get('/spark/kiosk/resource/case-studies/create', 'Kiosk\ResourceController@createCaseStudies')
        ->name('spark.kiosk.resources.case-studies.create');

    $router->get('/spark/kiosk/resource/case-studies/{id}', 'Kiosk\ResourceController@editCaseStudies')
        ->name('spark.kiosk.resources.case-studies.edit');

    $router->post('/spark/kiosk/resource/case-studies', 'Kiosk\ResourceController@storeCaseStudies')
        ->name('spark.kiosk.resources.case-studies.store');

    $router->put('/spark/kiosk/resource/case-studies/{id}', 'Kiosk\ResourceController@updateCaseStudies')
        ->name('spark.kiosk.resources.case-studies.update');
