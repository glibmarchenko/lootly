...
class VolusionEcommerceIntegrationService extends BaseEcommerceIntegrationService
{
    ...
    /**
     * VolusionEcommerceIntegrationService constructor.
     *
    ...
    protected function sendGenerateDiscountRequest($discountData)
    {
        ...
        if (!$rewardCoupon) {
            throw new ApiClientSetupError('An error has occurred while attempting to setup Volusion API client.');
        }
