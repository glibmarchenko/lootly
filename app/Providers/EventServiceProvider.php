...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'App\Events\OrderCreated' => [
            'App\Listeners\OrderCreatedHandler'
        ],

        'App\Events\CustomerEarnedPointsForAction' => [
            'App\Listeners\CustomerEarnedPointsForActionHandler'
        ],

        'App\Events\CustomerSpentPointsForReward' => [
            'App\Listeners\CustomerSpentPointsForRewardHandler'
        ],

        'App\Events\CustomerHaveEnoughPointsForReward' => [
            'App\Listeners\CustomerHaveEnoughPointsForRewardHandler'
        ],

        'App\Events\ReferralShareEmail' => [
            'App\Listeners\ReferralShareEmailHandler'
        ],

        'App\Events\ReferralReceiverRewardCouponGenerated' => [
            'App\Listeners\ReferralReceiverRewardCouponGeneratedHandler'
        ],

        'App\Events\ReferralSenderRewardCouponGenerated' => [
            'App\Listeners\ReferralSenderRewardCouponGeneratedHandler'
        ],

        'App\Events\ReferralSenderEarnedPoints' => [
            'App\Listeners\ReferralSenderEarnedPointsHandler'
        ],

        'App\Events\CustomerSpentPoints' => [
            'App\Listeners\CustomerSpentPointsHandler'
        ],

        'App\Events\CustomerEarnedVipTier' => [
            'App\Listeners\CustomerEarnedVipTierHandler'
        ],
    ];
