        ...
        <div class="spark-screen container">
            <div class="row">
              ...
              18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
                            ...
                            @if (Spark::usesTeams())
                                <li class="nav-item ">
                                    <a class="nav-link" href="#{{Spark::teamsPrefix()}}" aria-controls="teams"
              ...
              0-1.2-.2.8-1 1.3-2.4 1.3-3.8s0-2.7-1-3.8l1-.2z "/>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#security" aria-controls="security" role="tab"
                                   data-toggle="tab">
              ...
              1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z "/>
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="#shopify" aria-controls="" role="tab"
                                       data-toggle="tab">
                                        <svg class="icon-20 " xmlns="http://www.w3.org/2000/svg " viewBox="0 0 20 20 ">
                                            <path d="M4 2h16l-3 9H4c-.6 0-1 .4-1 1s.5 1 1 1h13v2H4c-1.7 0-3-1.3-3-3s1.3-3 3-3h.3L3 5 2 2H0V0h3c.5 0
              1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z "/>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" href="#employee" aria-controls="" role="tab"
                                           data-toggle="tab">
                                            <img style="    margin-right: 14px;height: 19px;width: 20px" src="data:image/png;base64,">
                                            {{__('Invite Employee')}}
                                        </a>
                                    </li>
                            </ul>
                ...
                <div class="col-md-9">
                    ...
                    <!-- Billing Tab Panes -->
                        ...
                        <!-- Payment Method -->
                            ...
                            <!-- shopify -->
                            <div role="tabcard" class="tab-pane" id="shopify">
                                @include('spark::settings.shopify')
                            </div>
                                <!-- Employe -->
                                <div role="tabcard" class="tab-pane" id="employee">
                                    @include('spark::settings.employee')
                                </div>
                        @endif
                    </div>
                </div>
