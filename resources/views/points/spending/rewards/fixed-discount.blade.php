                            ...
                            <div class="col-md-8">
                                <div class="form-group m-b-0">
                                    <label class="light-font m-b-0 m-t-5">
                                        Fixed amount discount is currently
                                        <span class="bold"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-0">
                                        ...
                                        <input class="form-control" v-model="form.reward.values"
                                               placeholder="e.g. 5" name=reward.values>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Fixed amount discount"
                                    ...
                                    <div class="form-group m-b-0">
                                        ...
                                        <label class="light-font m-b-0">
                                            <div style="float: left;"
                                                 v-text='(form.reward.values != "" ? (merchantSettings.currency.displaySign ? (merchantSettings.currency.selectedFormat + form.reward.values) : (form.reward.values + " " + merchantSettings.currency.selectedFormat)) : "{value}") + " off coupon expiration is"'>
                                            </div>
                                            &nbsp;
                                            <span class="bold"
    ...
    <script type="module">
      ...
      var page = new Vue({
        ...
        data: {
          ...
          reward_name_tags: ['{currency}', '{reward-value}', '{min-value}'], // second tag is using in min value generating
          ...
          saveAction: function () {
            ...
            axios.post('/points/spending/rewards/store', this.form).then((response) => {
              ...
              if (response.data.status == 404) {
                ...
                history.replaceState({}, '', '/points/spending/actions/fixed-discount/' + this.form.reward_id);
          ...
          rewardTextPreviewGen (get = false) {
            if (this.form.reward.points) {
              this.form.program.rewardText = this.form.program.rewardTextDefault
                ...
                .replace(/{min-value-phrase}/g, this.form.reward.minOrder ? `for orders over ${this.merchantSettings.currency.displaySign ? this.merchantSettings.currency.selectedFormat + '' + this.form.reward.minOrder : this.form.reward.minOrder + ' ' + this.merchantSettings.currency.selectedFormat}` : '')
            ...
            get: function () {
              ...
              if (this.form.reward.values) {
                ...
                return this.form.program.name = this.form.program.nameDefault
                  ...
                  .replace(/{reward-value}/g, this.form.reward.values ? this.form.reward.values : '')
                  .replace(/{currency}/g, this.form.reward.values ? sign : '')
                  .replace(/\&nbsp\;/g, ' ')
                  .replace(/(<([^>]+)>)/ig, '')
              } else {
