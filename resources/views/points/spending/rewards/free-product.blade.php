                ...
                <div class="col-md-7 col-12">
                            ...
                            <div class="col-md-8">
                                <div class="form-group m-b-0">
                                    <label class="light-font m-b-0 m-t-5">
                                        Free Product discount is currently
                                        <span class="bold"
                        ...
                        <div :class="{ 'loading' : loading }" v-cloak>
                            ...
                            <div class="row m-t-10">
                                <div class="col-md-12">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-10">
                                            <span>Reward value (@{{merchantSettings.currency.selectedFormat}}) (value automatically filled based on product price)</span>
                                        </label>
                                        <input class="form-control" v-model="form.reward.values" placeholder="e.g. 50"
                                               name="reward.values">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group m-b-0">
                                        ...
                                        <input class="form-control"
                                               name="reward.points"
                                               v-model="form.reward.points" placeholder="e.g. 1000">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Free Product discount"
                                          ...
                                          @else
                                            ...
                                            <div class="file-drag-drop m-t-15" v-cloak>
                                                ...
                                                <div class="custom-file-overlay">
                                                    <span class="img"
                                                          v-if="form.program.reward_icon || form.iconPreview">
                    ...
                    @else
                        <div class="well restrictions-section m-t-20 p-b-10">
                            <div :class="{ 'loading' : loading }" v-cloak>
                                @include('points.common_sections.restrictions', ['type' => 'Earning', 'restrictions' => ['customer']])
                            </div>
                        </div>
                    @endif
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        ...
                                        <label class="light-font m-b-0">
                                            Free Product coupon expiration is
                                            <span class="bold"
      ...
      var page = new Vue({
                ...
                if (response.data.rewards.merchant_reward.length === 0) {
                  ...
                  response.data.rewards.merchant_reward.forEach(function (merchant_reward, key) {
                    if (merchant_reward['id'] == _this.merchant_reward_id) {
                      ...
                      _this.form.reward.product = merchant_reward.product
                      ...
                      if(_this.form.reward.values) _this.form.reward.values = merchant_reward.reward_value
          ...
          saveAction: function () {
            ...
            axios.post('/points/spending/rewards/store', this.form).then((response) => {
              ...
              if (response.data.status == 404) {
                ...
                history.replaceState({}, '', '/points/spending/actions/free-product-discount/' + this.form.reward_id);
        ...
        watch: {
          'form.reward.product': function () {
            ...
            this.form.program.name = 'Free ' + productText
          }
        }
      })
    </script>
