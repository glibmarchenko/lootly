                            ...
                            <div class="col-md-8">
                                <div class="form-group m-b-0">
                                    <label class="light-font m-b-0 m-t-5">
                                        Percentage off discount is currently
                                        <span class="bold"
                                    ...
                                    <div :class="{ 'loading' : loading }" v-cloak>
                                        <div class="form-group m-b-0">
                                            ...
                                            <input class="form-control"
                                                   v-model="form.reward.points" placeholder="e.g. 10"
                                                   name="reward.points">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Percentage off discount"
                                    ...
                                    <div class="form-group m-b-0">
                                        ...
                                        <label class="light-font m-b-0">
                                            <div style="float: left;"
                                                 v-text='(form.reward.values != "" ? + form.reward.values : "{value}") + "% off coupon expiration is"'>
                                            </div>
                                            &nbsp;
                                            <span class="bold"
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            program: {
              ...
              status: 1,
              name: '% off discount',
              nameDefault: '{reward-value}% off discount {min-value}',
          ...
          icon_parent_el: 'precentage-discount',
          alert: {
            type: '',
            text: '',
            dismissSecs: 5,
          ...
          reward_name_tags: ['{reward-value}', '{min-value}'],  // second tag is using in min value generating
        ...
        methods: {
          ...
          saveAction: function () {
            ...
            axios.post('/points/spending/rewards/store', this.form).then((response) => {
              ...
              if (response.data.status == 404) {
                ...
                history.replaceState({}, '', '/points/spending/actions/percentage-discount/' + this.form.reward_id);
          ...
          rewardTextPreviewGen (get = false) {
            if (this.form.reward.points) {
              this.form.program.rewardText = this.form.program.rewardTextDefault
                ...
                .replace(/{min-value}/g, this.form.reward.minOrder ? 'for orders over' + formatCurrency(this.merchantSettings.currency.selectedFormat, this.form.reward.minOrder, this.merchantSettings.currency.displaySign) : '')
          ...
          minOrderGen: function () {
            ...
            const minTag = this.reward_name_tags[1]
