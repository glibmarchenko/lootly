    ...
    <div id="action-page" class="loader m-t-20 m-b-10" v-cloak>
        ...
        <form>
            <div class="row p-b-10 section-border-bottom">
                ...
                <div class="col-md-12">
                    <h3 class="page-title m-t-0 color-dark pull-left">Read Content</h3>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Read Content action is currently
                                            <span class="bold"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input class="form-control" name="content.url"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Read Content"
                        ...
                        <div class="well ">
                                <span :class="{'loading' : loading}">
                                    ...
                                    <div class="preview-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="left-preview-icon read-content"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            defaultActionName: 'Read Content',
            action_slug: 'read-content',
            program: {
              ...
              emailDefaultText: 'You just earned <strong>{points} {points-name}</strong> at {company-name} <br/>for reading our content link.',
              icon: null,
              icon_name: 'icon-content',
              action_icon: null,
            },
            content: {
              url: '',
          ...
          icon_default_class: 'icon-content',
          icon_parent_el: 'read-content',
          alert: {
            type: '',
            text: '',
            dismissSecs: 5,
          ...
          getDefaultParches: function () {
            axios.get('/points/earning/actions/get/' + this.form.defaultActionName).then((response) => {
              if (response.data.action.merchant_action.length === 0) {
                ...
                this.form.content.url = response.data.action.merchant_action[0].content_url
                this.form.content.url_ghost_text = response.data.action.merchant_action[0].content_url
