...
@section('title', 'TrustSpot - Reviews & UGC')

@section('content')
    <div id="action-page" class="loader m-t-20 m-b-10" v-cloak xmlns:v-on="http://www.w3.org/1999/xhtml">
        <b-alert v-cloak
        ...
        <form>
            <div class="row p-b-10 section-border-bottom">
                ...
                <div class="col-md-12">
                    <h3 class="page-title m-t-0 color-dark pull-left">TrustSpot - Reviews & UGC</h3>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Trustspot Review action is currently
                                            <span class="bold"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-15">
                                        ...
                                        <select class="mb-3 form-control custom-select" v-model="form.review.type">
                                            <option value="all" v-if="!forbidden_review_types.includes('all')">All</option>
                                            <option value="company" v-if="!forbidden_review_types.includes('company')">Write a Company Review</option>
                                            <option value="product" v-if="!forbidden_review_types.includes('product')">Write a Product Review</option>
                                            <option value="survey" v-if="!forbidden_review_types.includes('survey')">Submit an Experience Survey</option>
                                            <option value="photo" v-if="!forbidden_review_types.includes('photo')">Submit a Photo</option>
                                            <option value="video" v-if="!forbidden_review_types.includes('video')">Submit a Video</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="TrustSpot - Reviews & UGC"
                                                       v-on:keyup="changeRewardText"
                        ...
                        <div class="well ">
                                <span :class="{'loading' : loading}">
                                    ...
                                    <div class="preview-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="left-preview-icon review"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            defaultActionName: 'TrustSpot - Reviews & UGC',
            action_slug: 'trustspot-review',
            program: {
              ...
              emailDefaultText: 'You just earned <strong>{points} {points-name}</strong> at {company-name} <br/>for writing a review.',
              icon: null,
              icon_name: 'icon-star',
              action_icon: null
          ...
          icon_default_class: 'icon-star',
          icon_parent_el: 'review',
          alert: {
            type: '',
            text: '',
            dismissSecs: 5,
          ...
          getDefaultParches: function () {
            ...
            axios.get('/points/earning/actions/get/' + this.form.defaultActionName).then((response) => {
              if (response.data.action.merchant_action.length === 0) {
                this.form.program.name = response.data.action.name
                this.form.restrictions.ready = true
              } else {
                response.data.action.merchant_action.forEach( ( merchant_action, key ) => {

                  if ( merchant_action.id === Number( this.form.merchant_action_id ) ) {
                    ...
                    this.form.program.emailDefaultText = merchant_action.reward_email_text
                    this.form.review.status            = merchant_action.review_status
                    this.form.review.type              = merchant_action.review_type
                    this.form.earning.value            = merchant_action.point_value
                    this.form.restrictions.status      = merchant_action.restrictions_enabled
                    this.form.earning.limit.status     = merchant_action.earning_limit
                    this.form.earning.limit.value      = merchant_action.earning_limit_value
                    this.form.earning.limit.period     = merchant_action.earning_limit_period
                    this.form.program.rewardText       = merchant_action.reward_text
                    this.form.program.action_icon      = merchant_action.action_icon
                    this.form.emailNotification        = merchant_action.send_email_notification === '1'
                    this.form.zap                      = merchant_action.zap_name

                    if ((merchant_action.reward_default_text)) {
                      this.form.program.rewardTextDefault = merchant_action.reward_default_text
                    }
                  }
                  else {
                    this.forbidden_review_types.push( merchant_action.review_type );
                  }
                })
