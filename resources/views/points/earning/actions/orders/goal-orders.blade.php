    ...
    <div id="action-page" class="loader m-t-20 m-b-10" v-cloak>
        ...
        <form>
            <div class="row p-b-10 section-border-bottom">
                ...
                <div class="col-md-12">
                    <h3 class="page-title m-t-0 color-dark pull-left">Goal Orders</h3>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Goal Orders action is currently
                                            <span class="bold"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-10">
                                            <span>Order amount to reach goal</span>
                                        </label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Goal Orders"
                                            ...
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="1 point per $1 spent"
                        ...
                        <div class="well">
                            <span :class="{'loading' : loading}">
                                ...
                                <div class="preview-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="left-preview-icon goal-order"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            defaultActionName: 'Goal Orders',
            action_slug: 'goal-orders',
            program: {
              status: 1,
              name: 'Goal Orders',
              rewardText: '',
              rewardTextDefault: 'Complete {orders} Orders - {points} {points-name}',
              emailDefaultText: 'You just earned <strong>{points} {points-name}</strong> at {company-name} <br/>for completing {orders} Orders with us.',
              icon: null,
              icon_name: 'icon-goal-orders',
              action_icon: null,
            },
            earning: {
          ...
          icon_default_class: 'icon-goal-orders',
          icon_parent_el: 'goal-order',
          alert: {
            type: '',
            text: '',
            dismissSecs: 5,
          ...
          tags: ['{points}', '{points-name}', '{company-name}', '{orders}'],
          action_tags: ['{points}', '{points-name}', '{orders}'],
        },
        created: function () {
        ...
        methods: {
          ...
          getDefaultParches: function () {
            axios.get('/points/earning/actions/get/' + this.form.defaultActionName).then((response) => {
              if (response.data.action.merchant_action.length === 0) {
                ...
                this.form.earning.goal = response.data.action.merchant_action[0].goal
          ...
          saveAction: function () {
            this.loading = true
            axios.post('/api/merchants/' + Spark.state.currentTeam.id + '/earning/actions/goal-orders', this.form).then((response) => {
          ...
          changeRewardText: function () {
            ...
            this.form.earning.value = text[4]
          },
          generateRewardText: function () {
            ...
            return this.form.program.rewardText = this.form.program.rewardTextDefault
              ...
              .replace(/{currency}/g, this.form.currency)
              .replace(/{orders}/g, this.form.earning.goal ? this.form.earning.goal : '')
              .replace(/\&nbsp\;/g, ' ')
              .replace(/(<([^>]+)>)/ig, '')
          },
          generateRewardEmailText: function () {
            ...
            if (this.form.program.emailDefaultText) {
              return this.rewardEmailTextPreview = this.form.program.emailDefaultText
                ...
                .replace(/{orders}/g, this.form.earning.goal ? this.form.earning.goal : '{orders}')
            }
          },
