...
@section('title', 'Celebrate a Birthday')
    ...
    <div id="action-page" class="loader m-t-20 m-b-10" v-cloak>
        ...
        <form>
            <div class="row p-b-10 section-border-bottom">
                ...
                <div class="col-md-12">
                    <h3 class="page-title m-t-0 color-dark pull-left">Celebrate a Birthday</h3>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Celebrate a Birthday action is currently
                                            <span class="bold"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Celebrate a Birthday"
                                            ...
                                            <div>
                                                ...
                                                <!-- <textarea class="form-control" style="overflow: hidden;min-height: 95px;"
                                                        v-model="emailText"></textarea> -->
                        ...
                        <div class="well ">
                                <span :class="{'loading' : loading}">
                                    ...
                                    <div class="preview-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="left-preview-icon celebrate"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            point_namePlural: '',
            point_name: '',
            defaultActionName: 'Celebrate a Birthday',
            action_slug: 'celebrate-birthday',
            program: {
              status: 1,
              ...
              emailDefaultText: 'Happy Birthday from {company-name}! <br/>To help you celebrate we\'re awarding you <br/><strong>{points} {points-name}</strong>.',
              icon: null,
              icon_name: 'icon-birthday',
              action_icon: null,
          ...
          icon_default_class: 'icon-birthday',
          icon_parent_el: 'celebrate',
          alert: {
            type: '',
            text: '',
            dismissSecs: 5,
        ...
        methods: {
          ...
          saveAction: function () {
            this.loading = true
            axios.post('/api/merchants/' + Spark.state.currentTeam.id + '/earning/actions/celebrate-birthday', this.form).then((response) => {
