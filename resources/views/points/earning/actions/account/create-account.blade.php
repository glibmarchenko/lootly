    ...
    <div id="action-page" class="loader m-t-20 m-b-10" v-cloak>
        ...
        <form>
            <div class="row p-b-10 section-border-bottom">
                ...
                <div class="col-md-12">
                    <h3 class="page-title m-t-0 color-dark pull-left">Create an account</h3>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Create an account action is currently
                                            <span class="bold"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            ...
                                            <input class="form-control" placeholder="Create an account"
                                            ...
                                            <!-- <div class="reward-email-text">
                                                <trumbowyg v-model="form.program.rewardTextDefault" name="rewardTextDefault" :config="config" class="editor"></trumbowyg>
                                            </div> -->
                        ...
                        <div class="well ">
                            <span :class="{'loading' : loading}">
                                ...
                                <div class="preview-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="left-preview-icon account"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            point_namePlural: '',
            point_name: '',
            defaultActionName: 'Create an Account',
            action_slug: 'create-account',
            program: {
              status: 1,
              ...
              emailDefaultText: 'You just earned <strong>{points} {points-name}</strong> at {company-name} <br/>for creating an account with us.',
              icon: null,
              icon_name: 'icon-create-account',
              action_icon: null
            },
            earning: {
              value: '',
          ...
          icon_default_class: 'icon-create-account',
          icon_parent_el: 'account',
          alert: {
            type: '',
            text: '',
            dismissSecs: 5,
