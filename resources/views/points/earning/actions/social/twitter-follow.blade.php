    ...
    <div id="action-page" class="loader m-t-20 m-b-10" v-cloak>
        ...
        <form>
            <div class="row p-b-10 section-border-bottom">
                ...
                <div class="col-md-12">
                    <h3 class="page-title m-t-0 color-dark pull-left">Twitter Follow</h3>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Twitter Follow action is currently
                                            <span class="bold"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input class="form-control" v-on:keyup="changePoint"
                                               v-model="form.earning.value" name="earning.value" placeholder="e.g. 50">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-0">
                                        ...
                                        <input class="form-control" name="twitter.username"
                                               placeholder="@company"
                                               v-model="form.twitter.username">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Twitter Follow"
                        ...
                        <div class="well ">
                            <span :class="{'loading' : loading}">
                                ...
                                <div class="preview-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="left-preview-icon twitter-follow"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            defaultActionName: 'Twitter Follow',
            action_slug: 'twitter-follow',
            program: {
        ...
        methods: {
          ...
          getDefaultParches: function () {
            axios.get('/points/earning/actions/get/' + this.form.defaultActionName).then((response) => {
              if (response.data.action.merchant_action.length === 0) {
                ...
                this.form.twitter.username = response.data.action.merchant_action[0].twitter_username
                this.form.twitter.username_ghost_text = response.data.action.merchant_action[0].twitter_username
          ...
          saveAction: function () {
            ...
            axios.post('/api/merchants/' + Spark.state.currentTeam.id + '/earning/actions/' + this.form.action_slug, this.form).then((response) => {
              ...
              this.form.program.company_name = response.data.action.merchant_action[0].company_name
              this.loading = false
            }).catch((error) => {
              this.loading = false
              clearErrors(this.$el)
