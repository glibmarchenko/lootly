...
@section('title', 'Instagram Follow')
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Instagram Follow action is currently
                                            <span class="bold"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-0">
                                        ...
                                        <input class="form-control" name="instagram.username"
                                               placeholder="@company"
                                               v-model="form.instagram.username">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Instagram Follow"
                        ...
                        <div class="well ">
                            <span :class="{'loading' : loading}">
                                ...
                                <div class="preview-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="left-preview-icon instagram-follow"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            defaultActionName: 'Instagram Follow',
            action_slug: 'instagram-follow',
            program: {
              ...
              emailDefaultText: 'You just earned <strong>{points} {points-name}</strong> at {company-name} <br/>for following us on Instagram.',
              icon: null,
          ...
          icon_default_class: 'icon-instagram',
          icon_parent_el: 'instagram-follow',
          alert: {
            type: '',
            text: '',
            dismissSecs: 5,
          ...
          getDefaultParches: function () {
            axios.get('/points/earning/actions/get/' + this.form.defaultActionName).then((response) => {
              if (response.data.action.merchant_action.length === 0) {
                ...
                this.form.instagram.username = response.data.action.merchant_action[0].instagram_username
                this.form.instagram.username_ghost_text = response.data.action.merchant_action[0].instagram_username
