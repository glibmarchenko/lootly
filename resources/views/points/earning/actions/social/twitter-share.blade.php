    ...
    <div id="action-page" class="loader m-t-20 m-b-10" v-cloak>
        ...
        <form>
            <div class="row p-b-10 section-border-bottom">
                ...
                <div class="col-md-12">
                    <h3 class="page-title m-t-0 color-dark pull-left">Twitter Share</h3>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Twitter Share action is currently
                                            <span class="bold"
                        ...
                        <div :class="{ 'loading' : loading }" v-cloak>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-15">
                                        <label class="light-font m-b-10">
                                            <span>Twitter Share URL</span>
                                        </label>
                                        <input class="form-control" name="share.url"
                                               :placeholder="form.share.url_ghost_text ? form.share.url_ghost_text : 'https://twitter.com/trustspot'"
                                               v-model="form.share.url">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-0">
                                        ...
                                        <input class="form-control" placeholder="Share message"
                                               v-model="form.share.message">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Twitter Share"
                        ...
                        <div class="well">
                                <span :class="{'loading' : loading}">
                                    ...
                                    <div class="preview-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="left-preview-icon twitter-share"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            defaultActionName: 'Twitter Share',
            action_slug: 'twitter-share',
            program: {
              ...
              emailDefaultText: 'You just earned <strong>{points} {points-name}</strong> at {company-name} <br/>for following us on Twitter.',
              icon: null,
            ...
            share: {
              url: '',
              url_ghost_text: '',
              message: 'This store is amazing, check it out!'
            },
            twitter_share: {
              url: '',
            },
          ...
          icon_default_class: 'icon-twitter',
          icon_parent_el: 'twitter-share',
          alert: {
            type: '',
            text: '',
            dismissSecs: 5,
        ...
        methods: {
          ...
          bodyPreview () {
            ...
            const previewText = preview
              .replace(/{company-name}/g, '{{$company}}' || '{company-name}')
          ...
          getDefaultParches: function () {
            axios.get('/points/earning/actions/get/' + this.form.defaultActionName).then((response) => {
              if (response.data.action.merchant_action.length === 0) {
                ...
                this.form.share.url = response.data.action.merchant_action[0].share_url
                this.form.share.url_ghost_text = response.data.action.merchant_action[0].share_url
                this.form.share.message = response.data.action.merchant_action[0].share_message
          ...
          saveAction: function () {
            this.loadingSave = true
            this.loading = true
            this.form.twitter_share.url = this.form.share.url
          ...
          generateRewardEmailText: function () {
            if (this.form.earning.value) {
              const points_name = this.form.earning.value > 1 ? this.form.points : this.form.point
              return this.rewardEmailTextPreview = this.form.program.emailDefaultText
                .replace(/{points}/g, this.form.earning.value)
                .replace(/{points-name}/g, points_name ? points_name : '{points-name}')
                .replace(/{company-name}/g, '{{$company}}')
              // .replace('{reward-list}',  this.reward_list?  ' ' + this.reward_list : '{reward-list}');
            } else {
              return this.form.program.emailDefaultText
            }
          },
