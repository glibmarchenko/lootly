    ...
    <div id="action-page" class="loader m-t-20 m-b-10" v-cloak>
        ...
        <form>
            <div class="row p-b-10 section-border-bottom">
                ...
                <div class="col-md-12">
                    <h3 class="page-title m-t-0 color-dark pull-left">Facebook Share</h3>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group m-b-0">
                                        <label class="light-font m-b-0 m-t-5">
                                            Facebook Share action is currently
                                            <span class="bold"
                        ...
                        <div :class="{ 'loading' : loading }" v-cloak>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group m-b-15">
                                        <label class="light-font m-b-10">
                                            <span>Facebook Share URL</span>
                                        </label>
                                        <input class="form-control" name="share.url"
                                               :placeholder="form.share.url_ghost_text ? form.share.url_ghost_text : 'https://www.facebook.com/company'"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                ...
                                                <input class="form-control" placeholder="Facebook Share"
                        ...
                        <div class="well ">
                                <span :class="{'loading' : loading}">
                                    ...
                                    <div class="preview-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="left-preview-icon facebook-share"></label>
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            defaultActionName: 'Facebook Share',
            action_slug: 'facebook-share',
            program: {
