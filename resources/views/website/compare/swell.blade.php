...
@section('head')
    <title>Swell Rewards Alternative</title>
	<style type="text/css">
        @media(min-width: 880px) {
            .compare-main-sec {
                background-image: url('/images/assets/main/compare/lootly-swell-lg.png');
            }
        }
        @media(max-width: 880px) {
            .compare-main-sec {
                background-image: url('/images/assets/main/compare/lootly-swell.png');
            }
        }
	</style>
@endsection
...
@section('content')
    <section class="compare-main-sec"></section>
        		...
        		<div class="col-12">
        			<div class="text-center m-auto" style="max-width: 710px;">
	        			...
	        			<p class="m-t-30" style="font-size: 22px;">
	        				<span style="color: #444">Swell Rewards is very expensive. Lootly provides a comparable loyalty & rewards platform for a fraction of the cost.</span>
    			...
    			<div class="col-12">
			            ...
			            <table class="compare-table">
			        		<thead>
			        			<tr>
                                    ...
                                    <th><img src="{{ url('images/assets/main/compare/swell-logo.png') }}" alt=""><span>$249 Plan</span></th>
			        			</tr>
			        		</thead>
			        		<tbody>
			        			<tr>
                                    ...
                                    <td class="flex-center">
                                        ...
                                        <span class="desc">800 Orders <br> and $0.20 per order after 800.</span>
                                    </td>
			        			</tr>
			        			<tr>
        			...
        			<div class="text-center m-auto" style="max-width: 900px;">
	        			<p class="m-b-50" style="font-size: 24px;">
	        				<span style="color: #444">With Lootly if you have 1,000 orders a month, your $249 Plan is still $249 per month, but with Swell Rewards your price will go up to $289 per month.</span>
                ...
                <div class="col-12">
                    ...
                    <ul class="switch-to-lootly m-t-0">
                        <li>
                    		...
                    		<p class="bold" style="font-size: 17px;">Export from <br> Swell Rewards</p>
                    	</li>
                    	<li class="arrow">
                    		<span>
	        ...
	        <div class="row">
	            <div class="col-md-12 col-12">
	                <div class="sec-content">
	                    <h2 class="text-center" style="max-width: 550px; margin: 15px auto;">Discover why others are switching to Lootly from Swell Rewards</h2>
