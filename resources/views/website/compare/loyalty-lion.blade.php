...
@section('head')
    <title>Loyalty Lion Alternative</title>
    <style type="text/css">
        @media(min-width: 880px) {
            .compare-main-sec {
                background-image: url('/images/assets/main/compare/lootly-loyalty-lion-lg.png');
            }
        }
        @media(max-width: 880px) {
            .compare-main-sec {
                background-image: url('/images/assets/main/compare/lootly-loyalty-lion.png');
            }
        }
    </style>
@endsection
...
@section('content')
    <section class="compare-main-sec">
        <!-- <img src="{{ url('images/assets/main/compare/lootly-ship-1.png') }}" style="width: 100%; max-width: none;"> -->
    </section>
                ...
                <div class="col-12">
                    <div class="text-center m-auto" style="max-width: 710px;">
                        ...
                        <p class="m-t-30" style="font-size: 22px;">
                            <span style="color: #444">Loyalty Lion is very expensive. Lootly provides a comparable loyalty & rewards platform for a fraction of the cost.</span>
                ...
                <div class="col-12">
                        ...
                        <table class="compare-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><img src="{{ url('images/assets/main/compare/loyalty-lion-logo.png') }}" style="width: 140px;"><span>$159 Plan</span></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>Number of orders per month</td>
                                    <td><i class="fa fa-check-circle" aria-hidden="true"></i> Unlimited</td>
                                    <td><i class="fa fa-exclamation-circle" aria-hidden="true"></i> 800 Orders</td>
                                </tr>
                                <tr>
                    ...
                    <div class="text-center m-auto" style="max-width: 900px;">
                        <p class="m-b-50" style="font-size: 24px;">
                            <span style="color: #444">With Lootly if you have 1,000 orders a month, your $249 Plan is still $249 per month, but with Loyalty Lion your price will go up to $399 per month from $159.</span>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="switch-to-lootly m-t-0">
                        <li class="" style="padding: 15px 10px">
                            <img class="m-t-15" height="80" src="{{ url('images/assets/main/compare/export.png') }}">
                            <p class="bold" style="font-size: 17px;">Export from Loyalty Lion</p>
                        </li>
                        <li class="arrow">
                            <span>
            ...
            <div class="row">
                <div class="col-md-12 col-12">
                    <div class="sec-content">
                        <h2 class="text-center" style="max-width: 500px; margin: 15px auto;">Discover why others are switching to Lootly from Loyalty Lion</h2>
