...
@section('title', 'Magento 1 Integration')

@section('page-name', 'full-page')

@section('meta')
    <meta name="title" content="Magento 1 Integration | Lootly">
    <meta name="description" content="Grow your Magento 1 store with a Loyalty, Rewards, and Referrals platform by Lootly.">
    <meta name="keywords" content="magento, magento referrals, magento loyalty, magento 1 rewards, magento lootly">
    <meta property="og:title" content="Magento 1 Integration | Lootly">
    <meta property="og:image" content="{{ url('images/assets/main/integrations/magento-banner.png') }}">
    <meta property="og:url" content="{{ url('/apps/magento') }}">
    <meta property="og:description" content="Grow your Magento 1 store with a Loyalty, Rewards, and Referrals platform by Lootly.">
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="sec-content text-left">
                        <h1>Magento 1 Integration</h1>
                        <p class="description">Lootly empowers Magento 1 owners by integrating a feature-rich Loyalty & Referrals program into their shop in 1-click.</p>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <span class="flex-center">
                        <img class="m-auto" src="{{url('images/assets/main/integrations/magento-banner.png')}}">
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="sec-content flex-center">
                        <div>
                            <h2 class="f-s-38">Lootly & Magento 1 </h2>
                            <p class="f-s-18">Once Lootly is installed to your Magento 1 store, visitors can begin to understand how your loyalty & referrals program works in only a few clicks. Customize the design of everything to best match your brand and deliver an exciting new experience to visitors & customers</p>
                ...
                <div class="col-md-6 col-12">
                    <div class="sec-content flex-center">
                        <div>
                            ...
                            <p class="f-s-18">With over a dozen ways to Earn & Spend Points, you can build exciting ways for customers to interact with your Magento 1 store.</p>
                        </div>
                    </div>
                </div>
