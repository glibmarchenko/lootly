...
@section('title', 'BigCommerce Integration')

@section('page-name', 'full-page')

@section('meta')
    <meta name="title" content="BigCommerce Integration | Lootly">
    <meta name="description" content="Grow your BigCommerce store with a Loyalty, Rewards, and Referrals platform by Lootly.">
    <meta name="keywords" content="bigcommerce, bigcommerce referrals, bigcommerce loyalty, bigcommerce rewards, bigcommerce lootly">
    <meta property="og:title" content="BigCommerce Integration | Lootly">
    <meta property="og:image" content="{{ url('images/assets/main/integrations/bigcommerce-banner.png') }}">
    <meta property="og:url" content="{{ url('/apps/bigcommerce') }}">
    <meta property="og:description" content="Grow your BigCommerce store with a Loyalty, Rewards, and Referrals platform by Lootly.">
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="sec-content text-left">
                        <h1>BigCommerce Integration</h1>
                        <p class="description">Lootly empowers BigCommerce owners by integrating a feature-rich Loyalty & Referrals program into their shop in 1-click.</p>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <span class="flex-center">
                        <img class="m-auto" src="{{url('images/assets/main/integrations/bigcommerce-banner.png')}}">
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="sec-content flex-center">
                        <div>
                            <h2 class="f-s-38">Lootly & BigCommerce </h2>
                            ...
                            <p class="f-s-18">BigCommerce is just the begining, as Lootly includes numerous ways to connect with existing apps you already use, such as: TrustSpot for Reviews, Klaviyo & Mailchimp for Email Marketing and Facebook for social presence.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-12">
