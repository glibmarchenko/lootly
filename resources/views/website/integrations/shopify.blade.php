...
@section('meta')
    <meta name="title" content="Shopify Integration | Lootly">
    <meta name="description" content="Grow your Shopify store with a Loyalty, Rewards, and Referrals platform by Lootly.">
    <meta name="keywords" content="shopify, shopify plus, shopify referrals, shopify loyalty, shopify rewards, shopify lootly">
    <meta property="og:title" content="Shopify Integration | Lootly">
    <meta property="og:image" content="{{ url('images/assets/main/integrations/shopify-banner.png') }}">
    <meta property="og:url" content="{{ url('/apps/shopify') }}">
    <meta property="og:description" content="Grow your Shopify store with a Loyalty, Rewards, and Referrals platform by Lootly.">
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="sec-content text-left">
                        ...
                        <p class="description">Lootly empowers Shopify owners by integrating a feature-rich Loyalty & Referrals program into their shop in 1-click.</p>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <span class="flex-center">
                        <img class="m-auto" src="{{url('images/assets/main/integrations/shopify-banner.png')}}">
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="sec-content flex-center">
                        <div>
                            <h2 class="f-s-38">Lootly & Shopify </h2>
                            ...
                            <p class="f-s-18">Shopify is just the begining, as Lootly includes numerous ways to connect with existing apps you already use, such as: TrustSpot for Reviews, Klaviyo & Mailchimp for Email Marketing and Facebook for social presence.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-12">
