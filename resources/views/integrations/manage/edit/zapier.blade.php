...
@section('content')
    <div id="integration-settings" class="m-t-20 m-b-10">
        ...
        <form id="" :class="{ 'loading' : loading }" v-cloak>
            ...
            <div class="row p-t-25 p-b-25 section-border-bottom" style="display: none;">
                <div class="col-md-5 col-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div>
                                    <button @click.prevent="reinstallWidgetCode" class="btn btn-blue"
                                            ...
                                            style="padding-left: 15px; padding-right: 15px; margin-top: 15px;">Reinstall
                                        Widget Code
                                    </button>
            ...
            <div class="row p-t-25 p-b-25">
                ...
                <div class="col-md-7 col-12">
                    <div class="form-group m-b-20">
                        <div class="row">
                            <div class="col-md-8">
                                <input id="apiKey" placeholder="API Key" class="form-control" name="api.token"
                                       v-model="app.token" readonly>
                            </div>
                            <div class="col-md-2 p-l-0">
                                <button type="button" class="btn btn-copy w-100" @click="copyClipboard">Copy</button>
                            </div>
                            <div class="col-md-2 p-l-0">
                                <button type="button" class="btn btn-blue w-100" style="min-width: initial">Reset</button>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      var page = new Vue({
        ...
        methods: {
              ...
              axios.get('/api/merchants/' + Spark.state.currentTeam.id + '/settings').then((result) => {
                  if (result.data && result.data.data) {
                      ...
                      if (merchantSettings.details && merchantSettings.details.data) {
                          this.app.token = merchantSettings.details.data.api_key || null
                      }
          ...
          copyClipboard: function () {
              let couponField = document.querySelector('#apiKey')
              couponField.select()
