      ...
      var page = new Vue({
        ...
        computed: {
          ...
          emailTextPreview: function () {
            ...
            return this.form.program.emailText = this.form.program.emailTextDefault
              .replace(/{referral-name}/g, this.form.program.name)
              .replace(/{reward-text}/g, this.rewardTextPreview)
              .replace(/{company}/g, this.form.program.company_name)
          },
        },
        watch: {
