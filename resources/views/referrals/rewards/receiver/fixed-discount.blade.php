@extends('layouts.app')
@section('title', 'Fixed amount discount')
@section('content')
    ...
    <script type="module">
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            reward_id: '',
            defaultRewardName: 'Fixed amount discount',
            program: {
              name: 'They will receive',
              nameDefault: 'They will receive',
              rewardType: 'Fixed amount',
              rewardText: '',
              rewardTextDefault: '{currency}{reward-value} off discount {min-value}',
          ...
          minOrderGen: function () {
            ...
            if (!this.form.reward.minOrder) {
              if (name.indexOf(minPhrase) != -1) {
                this.form.program.rewardTextDefault = [
                  name.split(minPhrase)[0],
                  name.substr(name.indexOf(minPhrase) + minPhrase.length)
                ].join('')
              }
        ...
        watch: {
          'form.reward.values': function () {
            if (this.form.currency) {
              // this.form.program.rewardText = this.form.currency+this.form.reward.values+' off discount'
            }
          }
        }
      })
