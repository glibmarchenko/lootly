                            ...
                            <div class="row m-t-10" v-show="!merchantSettings.isWooCommerce">
                                <div class="col-md-12">
                                    <div class="form-group m-b-0">
                                        ...
                                        <input class="form-control" name="reward.maxShipping"
      ...
      var page = new Vue({
        ...
        data: {
          ...
          form: {
            ...
            program: {
              ...
              rewardText: '',
              rewardTextDefault: '{currency}{max-shipping} off shipping',
        ...
        methods: {
          ...
          minOrderGen: function () {
            const minPhrase = 'for orders over {min-shipping}'
            const minPhraseRegex = / *for orders over *{min-shipping}/g

            this.form.program.rewardTextDefault = this.form.program.rewardTextDefault.replace(minPhraseRegex, '')

            if (this.form.reward.minOrder) {
              this.form.program.rewardTextDefault = this.form.program.rewardTextDefault + ' ' + minPhrase
            }
          }
        },
        computed: {
