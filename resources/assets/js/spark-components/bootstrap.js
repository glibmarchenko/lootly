...
require('./kiosk/customers');
require('./kiosk/resources');
 ...
 * Authentication Components...
 */
require('./auth/employee-stripe');

/**
 * Shopify Settings Components...
 */
require('./settings/shopify');
require('./settings/shopify/update-shopify-data-stripe');
require('./settings/shopify/update-store');

/**
 * Invite Employee Settings Components...
 */
require('./settings/employee');
require('./settings/employee/invite-employee-data');